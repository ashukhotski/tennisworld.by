...
<form method="post"> 
	...
	<ul style="list-style:disc inside;">
		...
		<li style="color: #000000;font-size: 14px;">Visit the <a href="http://hybridauth.sourceforge.net/install.php#installer">HybridAuth</a> home page to make sure if there is a newer version.</li>
	</ul> 
